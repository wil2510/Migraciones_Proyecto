            ...
            <div class="d-flex align-items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">
                        Registra un nuevo centro de formación SENA.
                    </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5">
                ...
                <div class="h-100 p-4 p-lg-5 text-white"
                    ...
                    <p class="text-white-50" style="line-height: 1.7;">
                        Registra los centros de formación para organizar
                        los espacios y procesos académicos.
                    </p>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <small class="text-white-50">
                                    Guarda el centro en el sistema.
                                </small>
                            </div>
                        </div>
            ...
            <div class="col-lg-7">
                ...
                <div class="bg-white shadow-sm h-100" style="border-radius: 18px;">
                    ...
                    <form action="{{ route('trainingcenter.admin') }}" method="POST">
                        ...
                        <div class="p-4">
                            ...
                            <div class="p-3 mt-4"
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <small>
                                        Verifica el nombre y ubicación del centro
                        ...
                        <div class="p-4 border-top d-flex justify-content-end gap-2">
                            ...
                            <a href="{{ route('trainingcenter.index') }}"
